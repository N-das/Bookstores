...
$user_id = $_SESSION["user"];
    ...
    if($conn){
        if(isset($_POST['add_to_cart'])){
            ...
            $q="SELECT quantity from john_boyne  where book_id='$book_id'";
            $res=mysqli_query($conn,$q);
            $quon=mysqli_fetch_assoc($res);
            $remaining=$quon['quantity']-$product_quantity;
            $qry = mysqli_query($conn,"UPDATE john_boyne SET quantity = $remaining WHERE book_id = '$book_id'");
       ...
       <div class="author">
            <div class="auth_img">
                ...
                <div class="auth_detail">
                    <h1>john boyne</h1>
                    <p>John Boyne (born 30 April 1971) is an Irish novelist. He is the author of fourteen novels for adults, six novels for younger readers, two novellas and one collection of short stories. His novels are published in over 50 languages.</p>
                </div>
            </div>
            <div class="auth1">
                <div class="auth">
