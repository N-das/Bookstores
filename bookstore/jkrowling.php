...
$user_id = $_SESSION["user"];
    ...
    if($conn){
        if(isset($_POST['add_to_cart'])){
            ...
            $q="SELECT quantity from jk_rowling  where book_id='$book_id'";
            $res=mysqli_query($conn,$q);
            $quon=mysqli_fetch_assoc($res);
            $remaining=$quon['quantity']-$product_quantity;
            $qry = mysqli_query($conn,"UPDATE jk_rowling SET quantity = $remaining WHERE book_id = '$book_id'");
       ...
       <div class="author">
            <div class="auth_img">
                ...
                <div class="auth_detail">
                    <h1>Jk rowling</h1>
                    <p>J.K. Rowling, in full Joanne Kathleen Rowling, pen name of Joanne Rowling, (born July 31, 1965, Yate, near Bristol, England), British author, creator of the popular and critically acclaimed Harry Potter series, about a young sorcerer in training.</p>
                </div>
            </div>
            <div class="auth1">
                <div class="auth">
