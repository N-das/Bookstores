...
$user_id = $_SESSION["user"];
    ...
    if($conn){
        if(isset($_POST['add_to_cart'])){
            ...
            $q="SELECT quantity from vikram_sampath  where book_id='$book_id'";
            $res=mysqli_query($conn,$q);
            $quon=mysqli_fetch_assoc($res);
            $remaining=$quon['quantity']-$product_quantity;
            $qry = mysqli_query($conn,"UPDATE vikram_sampath SET quantity = $remaining WHERE book_id = '$book_id'");
       ...
       <div class="author">
            <div class="auth_img">
                ...
                <div class="auth_detail">
                    <h1>Vikram Sampath</h1>
                    <p>Vikram Sampath FRHistS is an Indian popular historian who is noted for writing biographies of Gauhar Jaan and Vinayak Damodar Savarkar. Sampath was born in Karnataka. After academic training in engineering, mathematics, and finance, he worked in banking.
                    </p>
                </div>
            </div>
            <div class="auth1">
