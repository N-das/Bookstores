...
$user_id = $_SESSION["user"];
    ...
    if($conn){
        if(isset($_POST['add_to_cart'])){
            ...
            $q="SELECT quantity from collen_hover  where book_id='$book_id'";
            $res=mysqli_query($conn,$q);
            $quon=mysqli_fetch_assoc($res);
            $remaining=$quon['quantity']-$product_quantity;
            $qry = mysqli_query($conn,"UPDATE collen_hover SET quantity = $remaining WHERE book_id = '$book_id'");
