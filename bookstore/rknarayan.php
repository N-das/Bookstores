...
$user_id = $_SESSION["user"];
    ...
    if($conn){
        if(isset($_POST['add_to_cart'])){
            ...
            $q="SELECT quantity from rk_narayan  where book_id='$book_id'";
            $res=mysqli_query($conn,$q);
            $quon=mysqli_fetch_assoc($res);
            $remaining=$quon['quantity']-$product_quantity;
            $qry = mysqli_query($conn,"UPDATE rk_narayan SET quantity = $remaining WHERE book_id = '$book_id'");
...
<body>
    <div class="main">
       ...
       <div class="author">
            <div class="auth_img">
                <img src=".\images\rknarayan.jpg" alt="">
                <div class="auth_detail">
                    <h1>Rk Narayan</h1>
                    <p>R. K. Narayan was born on 10 October 1906 and passed away in 2001. In his long career he published fourteen novels, over two hundred short stories, a memoir, two travel books, innumerable essays, and two plays. His first novel was Swami and Friends (1935).</p>
                </div>
            </div>
            <div class="auth1">
                <div class="auth">
