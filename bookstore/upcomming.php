    ...
    <div class="main">
       ...
       <div class="author">
            ...
            <div class="auth1">
                <div class="auth">
                    <?php  
                $select_products = mysqli_query($conn, "SELECT * FROM `upcomming` LIMIT 9") or die('query failed');
                if(mysqli_num_rows($select_products) > 0){
                    while($fetch_products = mysqli_fetch_assoc($select_products)){
                    ?>
                    <form action="" method="post" class="box">
                    <img class="image" src=".\images\<?php echo $fetch_products['image']; ?>" alt="" style="height: 100%; width: 85%;">
